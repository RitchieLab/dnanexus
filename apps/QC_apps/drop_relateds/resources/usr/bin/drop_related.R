...
if(!is.installed('optparse')){install.packages('optparse',repos="http://cran.us.r-project.org")}
if(!is.installed('reshape2')){install.packages('reshape2',repos="http://cran.us.r-project.org")}
if(!is.installed('foreach')){install.packages('foreach',repos="http://cran.us.r-project.org")}
if(!is.installed('doMC')){install.packages('doMC',repos="http://cran.us.r-project.org")}
...
for(cc in conn_comp[lapply(conn_comp, length)>1]){
	print(cc)
