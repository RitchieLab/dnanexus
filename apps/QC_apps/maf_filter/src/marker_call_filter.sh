...
main() {
    ...
    OUTPUT_PREFIX=maf_filter

    $PLINK_CMD --bed bed_file --bim bim_file --fam fam_file --noweb --allow-no-sex --out $OUTPUT_PREFIX.orig --write-snplist
    $PLINK_CMD --bed bed_file --bim bim_file --fam fam_file --noweb --allow-no-sex --maf $threshold --out $OUTPUT_PREFIX.filtered --write-snplist
